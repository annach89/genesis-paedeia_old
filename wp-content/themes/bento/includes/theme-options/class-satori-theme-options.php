...
class Satori_Theme_Options {
					...
					<div class="theme-options-links">
						<div class="theme-options-links-inner">';
							...
							echo '<div class="links-section links-support">
								...
								<a href="http://satoristudio.net/contact#contact-form" target="_blank"><span class="dashicons dashicons-sos" style="color:#FF9673;"></span>Contact support<span class="links-pointer"></span></a>
							</div>
							<!--
	...
	public function display_setting( $args = array() ) {
		...
		switch ( $type ) {
			...
			case 'upload':
				echo '<div class="upload-container ' . $id . '"><input id="' . $id . '" name="satori_options[' . $id . ']" type="text" value="' . esc_attr( $options[$id] ) . '" /></div><input id="' . $id . '_button" class="button media-button upload-button" ' . $disabled . ' name="' . $id . '" type="button" value="Upload" />';
				if ( $desc != '' ) {
