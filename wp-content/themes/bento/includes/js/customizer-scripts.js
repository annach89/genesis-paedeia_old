...
$str(document).ready(function() {
	...
	if ( phpvars.license_status == 'invalid' ) {
		links += '<a class="bnt-extra-link bnt-extra-link-2" style="color:darkorange" href="http://satoristudio.net/bento-free-wordpress-theme/?utm_source=customizer&utm_medium=theme&utm_campaign=theme#expansion-pack" target="_blank"><span class="dashicons dashicons-carrot"></span>'+phpvars.exp+'</a>';
	}
